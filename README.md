...
<body>
  ...
  <div class="container mt-5">
    <div class="row">
      ...
      <div class="col-md-4">
        <img src="phar.webp" class="img-fluid" alt="Pharmacy Image">
      </div>
    </div>
  </div>
  ...
  <footer class="bg-dark text-white text-center py-4 mt-5">
    <p>&copy; 2024 PharmaPlus. All rights reserved. BY SHANMUGAKARTHIK G (212223220105)</p>
  </footer>
  ...
  <div class="container mt-3">
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="card-deck">
          <div class="card">
            <img src="otc.jpg" class="card-img-top" alt="Product 1" width="200" height="200">
            <div class="card-body">
          ...
          <div class="card">
            <img src="dep.webp" class="card-img-top" alt="Product 2" width="200" height="200">
            <div class="card-body">
          ...
          <div class="card">
            <img src="vac.jpg" class="card-img-top" alt="Product 2" width="200" height="200">
            <div class="card-body">
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        ...
        <address>
          ...
          pharmaplus@pharmacompany.com<br><br>
